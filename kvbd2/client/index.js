...
function loginButtonHandler() {
	...
	if (!email || !password) return alert('Email and password fields must not be empty!')
	...
	// Зациклили отрисовку получаемых сообщений (костыль)
...
async function sendButtonHandler() {
	...
	if (!fellowEmail || !message) return alert('Friend\'s email and message fields must not be empty!')
...
async function drawMessages() {
	// отправить запрос на получение массива всех сообщений в формате { email, password } на api/getAllMessages()
